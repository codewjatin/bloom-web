...
import { GlobeAltIcon, MenuIcon, UserCircleIcon, UsersIcon, SearchIcon, BookmarkIcon } from '@heroicons/react/solid'
    ...
    return (
        <header className="sticky top-0 z-50 grid grid-cols-3 bg-white shadow-md py-5 px-5 md:px-10">
            ...
            <div className="flex items-center md:border-2 rounded-full py-2 md:shadow-sm">
                ...
                />
                <SearchIcon 
                    className=" md:inline-flex h-8 bg-green-600 text-white rounded-full p-2 cursor-pointer md:mx-2"
                    onClick={search} 
                />
            </div>
