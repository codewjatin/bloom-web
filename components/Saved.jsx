      ...
      <section className="mt-16 px-20 flex justify-around flex-wrap gap-x-4 gap-y-8">
            ...
            //   key={i}
              ...
              <div className="p-6 ml-1 mr-4 sm:px-0">
                <header className="flex gap px-5 ">
                  <a
                    href="#"
                  ...
                  <div className="inline-flex">
                    <h3 className="text-xl font-medium text-slate-700 mr-6 ml-2 mt-2">
                  ...
                  <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M13.5 6H5.25C4.65326 6 4.08097 6.23705 3.65901 6.65901C3.23705 7.08097 3 7.65326 3 8.25V18.75C3 19.3467 3.23705 19.919 3.65901 20.341C4.08097 20.7629 4.65326 21 5.25 21H15.75C16.3467 21 16.919 20.7629 17.341 20.341C17.7629 19.919 18 19.3467 18 18.75V10.5M7.5 16.5L21 3M21 3H15.75M21 3V8.25" stroke="black" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                    </svg>  
                    <span>Verify</span>
                  </button>
                  </div>
